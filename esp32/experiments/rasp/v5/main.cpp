...
boolean is_valid_json(JsonObject doc, Vector<String> keys)
{
  for (String key : keys)
...
void setup()
{
  ...
  String jsonStr1 = "{\"removed\":[{\"id\":1234}],"
                    "\"updated\": [{\"id\":1325,\"roomId\":\"room-id-5123\",\"userType\":\"PROFESSOR\",\"dayOfWeek\":\"MONDAY\","
                    "\"beginTime\": \"05:30\",\"endTime\":\"09:30\",\"lastUpdate\":\"2021-02-02 00:00:00\"}]}";

  app.updateInternalSchedules(jsonStr1);

  String jsonSql2 = "{\"removed\":[{\"userId\":1234}],"
                    "\"updated\": [{\"uid\":\"1325\",\"userId\":1234,\"userType\":\"PROFESSOR\",\"lastUpdate\":\"2021-02-02 00:00:00\"}]}";

  app.updateInternalKeyrings(jsonSql2);
}
