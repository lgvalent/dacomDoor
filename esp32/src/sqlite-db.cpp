...
class DebugDbNoopLog : public SqliteDB
{
public:
  DebugDbNoopLog(const char *filename) : SqliteDB(filename) {}
...
class DebugDbLog : public SqliteDB
{
public:
  DebugDbLog(const char *filename) : SqliteDB(filename) {}
